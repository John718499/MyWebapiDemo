...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnType("int")
                        .HasColumnName("InstructorID");
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.VwCourseStudent", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.VwCourseStudentCount", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.VwDepartmentCourseCount", b =>
                {
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.Course", b =>
                {
                    b.HasOne("MyWebapiDemo.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.CourseInstructor", b =>
                {
                    b.HasOne("MyWebapiDemo.Models.Course", "Course")
                    ...
                    b.HasOne("MyWebapiDemo.Models.Person", "Instructor")
                        .WithMany("CourseInstructors")
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("MyWebapiDemo.Models.Person", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("MyWebapiDemo.Models.OfficeAssignment", b =>
                {
                    b.HasOne("MyWebapiDemo.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("MyWebapiDemo.Models.OfficeAssignment", "InstructorId")
